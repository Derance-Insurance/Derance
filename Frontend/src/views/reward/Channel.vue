      ...
      <el-col :span="8">
        <el-card class="item box-card">
          <div class="item-info">
            ...
            <div class="balance">{{$etherToNumber(rewards[0])}} RANCE</div>
      ...
      <el-col :span="8">
        <el-card class="item box-card">
          <div class="item-info">
            ...
            <div class="balance">{{$etherToNumber(rewards[1])}} RANCE</div>
      ...
      <el-col :span="8">
        <el-card class="item box-card">
          <div class="item-info">
            ...
            <div class="balance">{{$etherToNumber(rewards[2])}} RANCE</div>
