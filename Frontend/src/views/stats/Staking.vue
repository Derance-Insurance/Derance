      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="Total Amount Staked">
            ...
            <highlight v-else><span v-format="'#,##0.00'">{{$etherToNumber(allStaked)}}</span> RANCE</highlight>
        ...
        <el-col :span="12">
          <el-form-item label="Total Staking Reward">
            ...
            <highlight v-else><span v-format="'#,##0.00'">{{$etherToNumber(allRewards)}}</span> RANCE</highlight>
