      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="Incentive">
            {{$etherToNumber(options.active.commonIncentive)}} RANCE
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
export default {
  ...
  computed: {
    ...
    quorumProgress(){
      ...
      const b = BigNumber(this.totalRANCE).plus(this.$ether(this.members.toString()).toString());
