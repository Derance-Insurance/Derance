  ...
  <div id="stake-overall">
    <el-card class="box-card">
      <el-form :disabled="!member.isMember">
        <el-row>
          <h2 class="main-text">Derance Staking</h2>
          <span class="normal-text">Earn rewards by staking RANCE on projects you think are secure.</span>
        ...
        <div class="overall">
          ...
          <el-row class="highlight" :gutter="20">
            <el-col :span="8">{{$etherToNumber(options.allStaked)}} RANCE</el-col>
            <el-col :span="8">{{$etherToNumber(purchasedCover)}} BNB</el-col>
            <el-col :span="8">{{$etherToNumber(member.rewards)}} RANCE</el-col>
          </el-row>
        </div>
      </el-form>
    </el-card>
