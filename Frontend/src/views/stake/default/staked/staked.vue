    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-card class="box-card">
          ...
          <div class="content">
            <div class="normal-text-bold">
              {{toFixed(availableStaking)}} RANCE
            </div>
            <div class="normal-text">
              <highlight>Leverage</highlight> your deposit for more rewards by staking your available RANCE. <svg-icon icon-class="broken-line"></svg-icon>
            </div>
            <br />
            <div class="buttonArea" style="text-align: center;">
