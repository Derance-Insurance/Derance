  ...
  <div v-loading.fullscreen.lock="loading"
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span class="page-title">My RANCE holdings</span>
  ...
  methods: {
    ...
    withdraw(){
      if(this.member.allowance == "0"){
        this.$message.error("Grant TokenController permission is 0 RANCE, Please grant TokenController enough permission.");
        return;
      }
      if(this.member.allowance < this.member.balance){
        this.$message.error(`Grant TokenController permission is ${this.member.allowance} RANCE, Please grant TokenController enough permission.`);
        return;
      }
      this.$confirm(`All the RANCE coins in your account will be burned after membership withdrawn. Do you want to continue?`, 'Tooltip', {
    ...
    amountFormat(row, column){
      ...
      return value != "N/A" ? value + "RANCE" : value;
    },
