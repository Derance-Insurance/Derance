<template>
  <div id="registerMember" v-loading.fullscreen.lock="loading"
    ...
    <el-row>
      ...
      <label class="normal-text">Being a member of Derance Insurance gives you the ability to buy cover, swap RANCE tokens, and also earn rewards from staking, governance and claim assessments.</label>
    </el-row>
    ...
    <el-row class="line-height-1">
      <span class="secondary-text">By becoming a member you agree to the conditions specified in the
        <el-link type="primary" :underline="false" target="_blank" href="pdf/DeranceRulesV1.0.pdf">Member Rules</el-link>.
      </span>
    </el-row>
    <el-row class="line-height-1">
