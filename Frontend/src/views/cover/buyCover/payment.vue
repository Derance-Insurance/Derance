  ...
  <div id="cover-buyCover-payment" v-loading.fullscreen.lock="loading"
    ...
    <el-card class="box-card secondary-text">
      <div slot="header" class="clearfix">
        ...
        <LiBorderRadius class="balance" v-if="currency=='RANCE'">
            Balance: {{$etherToNumber(member.balance.toString())}} RANCE
        </LiBorderRadius>
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <el-form-item label="Quote">
            {{$etherToNumber(options.quote.price.toString())}} BNB / {{$etherToNumber(options.quote.priceInNXM.toString())}} RANCE
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="14" style="line-height: 35px;">
          <div>
            ...
            Cover is provided on a discretionary basis with Derance members
          ...
          <div style="float: right;">
            <el-form-item label="Buy cover using">
              <el-radio-group v-model="currency" style="width:260px">
                ...
                <el-radio-button label="RANCE">RANCE</el-radio-button>
              </el-radio-group>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    buyUseRANCE(){
      ...
      contract.instance.makeCoverUsingRANCETokens(
